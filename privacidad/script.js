...
document.addEventListener('DOMContentLoaded', function() {
            ...
            // Smooth scroll cuando se hace click en TOC
            ...
            window.addEventListener('scroll', function() {
                ...
                // Actualizar clase active en TOC
                tocLinks.forEach(link => {
...
mobileLinks.forEach(link => {
    ...
    // Purpose: Trigger fade-in animation when elements enter viewport
    ...
    // Purpose: Render vertical-specific content and chat simulation
    // Data: verticalData object contains chat messages and capability tags
    const verticalData = {
        salud: {
            chat: [
    ...
    // Init first tab if exists
    const firstTab = document.querySelector('.vertical-tab');
    if (firstTab) {
        firstTab.click();
    }